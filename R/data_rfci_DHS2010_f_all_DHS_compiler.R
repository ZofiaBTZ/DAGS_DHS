...
############# variables 1992
ind_MWIR61 <-  read.dta("//home//b//zbaran/Documents/Genf/Malawi-SNF/Malawi_DHS//MWIR61DT//MWIR61FL.DTA")
...
ind_MWIR61[which(!(ind_MWIR61[,'v744a']==0 & ind_MWIR61[,'v744b']==0 & ind_MWIR61[,'v744c']==0 
                 & ind_MWIR61[,'v744d']==0 & ind_MWIR61[,'v744e']==0)),'v744a'] <- 1 
...
ind_MWIR61[which(is.na(ind_MWIR61[,'v769'])),'v769']<-0# 'no'
...
DHS_indicators <-list(
 # list(var= "F_hiv03", level = 1, label = "HIV status"),
  ...
  list(var = "v531", level = c(1,2,3,4,5,6,7,8,9), label = "First \n sex < 16 "), # change to 15
