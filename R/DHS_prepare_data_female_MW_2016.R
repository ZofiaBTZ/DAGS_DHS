...
#          'v743a'] <-"3"
  ...
  DHS_indicators <-list(
    ...
    list(var = "v158", level = 1, label = "Media access"),
  ...
  #  list(var = "v633a", level = 2, label = "Exist reason \n for no sex"),
    ...
    list(var = "v754jp", level = c(1,3), label = "False \n beliefs AIDS"),
...
to_analyze_MW_females_HIV_2016 <- DHS_prepare_data(data_path_2016, HIV_path_2016, var_csv)
...
View(to_analyze_MW_females_HIV_2016$description)
...
saveRDS(to_analyze_MW_females_HIV_2016, "to_analyze_MW_females_HIV_2016.rds")

write.csv(to_analyze_MW_females_HIV_2016$description, "to_analyze_MW_females_HIV_2016.csv")
