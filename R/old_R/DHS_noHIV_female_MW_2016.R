...
to_analyze_MW_females_2016 <- DHS_prepare_data(data_path_2016, HIV_path_2016, var_csv)
...
View(to_analyze_MW_females_2016$description)
...
saveRDS(to_analyze_MW_females_2016, "to_analyze_MW_females_2016.rds")

write.csv(to_analyze_MW_females_2016$description, "to_analyze_MW_females_2016.csv")
