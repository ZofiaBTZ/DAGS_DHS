...
DHS_prepare_data <- function(data_path, HIV_path = "", var_csv){
  ...
  table(DHS_sub$v744b)
  DHS_sub[which(!(DHS_sub[,'v744b']=='no' & DHS_sub[,'v744b']=='no' & DHS_sub[,'v744c']=='no' 
                   & DHS_sub[,'v744d']=='no' & DHS_sub[,'v744e']=='no')),'v744b'] <- 'yes'
  ...
  DHS_sub[which(is.na(DHS_sub[,'v754jp'])),'v754jp']<- 'don\'t know'
...
#          'v743a'] <-"3"
  ...
  DHS_indicators <-list(
    ...
    list(var = "v130", level = 4, label = "Religion"),
    list(var = "v151", level = 2, label = "Househead"),
    list(var = "v155", level = 2, label = "Literacy"),
    list(var = "v158", level = c(1,2), label = "Media access"),
  ...
  #  list(var = "v633a", level = 2, label = "Exist reason \n for no sex"),
    ...
    list(var = "v754jp", level = c(1,2), label = "False \n beliefs AIDS"),
...
HIV_path_2000 <- "" #//home//b//zbaran/Documents/Genf/Malawi-SNF/Malawi_DHS//MW



#MHH <- "//home//b//zbaran/Documents/Genf/Malawi-SNF/Malawi_DHS//MW_2015-16_DHS_03092018_45_117973/MWAR7ADT/MWAR7AFL.DTA

to_analyze_MW_females_HIV_2000 <- DHS_prepare_data(data_path_2000, HIV_path_2000, var_csv)
...
View(to_analyze_MW_females_HIV_2000$description)
...
saveRDS(to_analyze_MW_females_HIV_2000, "to_analyze_MW_females_HIV_2000.rds")

write.csv(to_analyze_MW_females_HIV_2000$description, "to_analyze_MW_females_HIV_2000.csv")
