...
to_analyze_MW_females_HIV_2010 <- DHS_prepare_data(data_path_2010, HIV_path_2010, var_csv)
...
View(to_analyze_MW_females_HIV_2010$description)
...
saveRDS(to_analyze_MW_females_HIV_2010, "to_analyze_MW_females_HIV_2010.rds")

write.csv(to_analyze_MW_females_HIV_2010$description, "to_analyze_MW_females_HIV_2010.csv")
