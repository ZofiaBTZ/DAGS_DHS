...
DHS_prepare_data <- function(data_path, var_csv="//home//b//zbaran/Documents/Genf/Malawi-SNF/process_DHS/clean_DHS/output/MWMR7HFL_levels.csv"){
  ...
  #DHS_sub[which(!(DHS_sub[,'mv754jp'] =='no' & DHS_sub[,'mv754wp']=='yes' 
  #                 & DHS_sub[,'mv756'] == 'yes'))
...
#          'mv743a'] <-"3"
  ...
  DHS_indicators <-list(
    ...
    list(var = "mv158", level = 1, label = "Media access"),
